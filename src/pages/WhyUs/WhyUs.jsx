            ...
            <div className="space-y-12">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                    We Do Not Charge for Non-Working Data
                  </h3>
                  <p className="text-gray-600 leading-relaxed">
                    We do not charge for data that bounces. You won’t have to
                    pay for anything that doesn’t work.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    With more than a decade of experience, we know our game and
                    tricks to deliver the best results.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                    Verified Information & Contact List
                  </h3>
                  <p className="text-gray-600 leading-relaxed">
                    All the information and contact lists we provide are
                    verified by our experienced compliance & quality teams.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                    Serving Every Industry & Sector
                  </h3>
                  <p className="text-gray-600 leading-relaxed">
                    We serve businesses of all sizes and industries. Our goal is
          ...
          >
            ...
            <div className="prose max-w-none">
              <p className="text-gray-600 leading-relaxed mb-6">
                Our commitment to excellence is reflected in our methodical
                approach to solving complex business challenges. We leverage
              ...
              <ul className="space-y-4 text-gray-600 list-none pl-0">
                <li className="flex items-center gap-3">
                  ...
                  Comprehensive enterprise solutions tailored to your specific
                  requirements
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-1 h-1 bg-gray-400 rounded-full"></div>
                ...
                <li className="flex items-center gap-3">
                  <div className="w-1 h-1 bg-gray-400 rounded-full"></div>
                  Robust security frameworks ensuring data protection and
                  compliance
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-1 h-1 bg-gray-400 rounded-full"></div>
                  Scalable infrastructure designed for future growth and
                  adaptation
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-1 h-1 bg-gray-400 rounded-full"></div>
